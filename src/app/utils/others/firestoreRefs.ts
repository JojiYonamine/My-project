...
export const taskThemesRef = (cid:string) => collection(db,"couples",cid,"taskThemes")

export const taskThemeRef = (cid:string,theme:string) => doc(db,"couples",cid,"taskThemes",theme)
